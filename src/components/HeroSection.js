...
function HeroSection() {
  ...
  return (
    <div className="relative h-auto md:h-[500px] before:bg-gradiant-to-r before:from-purple-500 before:to-transparent before:absolute before:inset-0 before:w-full before:h-full before:z-10">
      <Slider {...settings}>
        <div>
          <img
      ...
      <div className="container flex justify-between items-center relative md:absolute top-0 left-1/2 -translate-x-1/2 h-full z-20">
